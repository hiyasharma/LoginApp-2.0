<%-- 
    Document   : activation_success
    Created on : 28 Dec 2024, 6:54:23 pm
    Author     : hiyas
--%>
...
<HTML>
    ...
    <BODY LANG="en-US" DIR="LTR">
        ...
        <TABLE WIDTH=100% BORDER=0 CELLPADDING=4 CELLSPACING=0>
            ...
            <TR VALIGN=TOP>
                <TD WIDTH=50%>
                    <P><FONT COLOR="#0000ff"><B>User activation Successful!! <A HREF="index.jsp">Click here to Login</A></B></FONT></P>
                </TD>
                <TD WIDTH=50%>
                    <P ALIGN=RIGHT>
                        <FONT SIZE=3>
